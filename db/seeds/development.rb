# Destructive demo content for fresh, disposable development databases only.
raise "Development seed may only run in development" unless Rails.env.development?
